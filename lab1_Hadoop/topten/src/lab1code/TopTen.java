...
public class TopTen {
    ...
    public static class TopTenMapper extends Mapper<Object, Text, NullWritable, Text> {
        ...
        //TopTenMapper tmap = new TopTenMapper();
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            /*try {
                int rep = Integer.valueOf(reputation).intValue();
    ...
    public static class TopTenReducer extends Reducer<NullWritable, Text, NullWritable, Text> {
        ...
        public void reduce(NullWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            for (Text value : values) {
                ...
                //int rep = Integer.valueOf(parsed.get("Reputation")).intValue(); 
            }
...
/*
This happens because Hadoop is reusing Text instances and changing their contents rather than creating new instances. 
You can solve this problem by storing a deep copy of the value in your data structure instead
*/
